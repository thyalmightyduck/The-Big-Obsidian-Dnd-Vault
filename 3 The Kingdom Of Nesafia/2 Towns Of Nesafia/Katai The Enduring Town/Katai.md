```leaflet  
id: KataiTownMapLeaf ### Must be unique with no spaces  
image: [[katai.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [4364, 3844]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
...
long: 1722 ### To center the map, make this half of the map width.  
