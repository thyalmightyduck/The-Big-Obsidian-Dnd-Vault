```leaflet  
id: ThalanorCityMapLeaf ### Must be unique with no spaces  
image: [[thalanor.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [4507, 3722]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
height: 700px ### Size of the leaflet embed in px on your screen  
width: 95% ### Size of the leaflet embed in your note  
lat: 2100 ### To center the map, make this half of the map height.  
long: 1861 ### To center the map, make this half of the map width.  
