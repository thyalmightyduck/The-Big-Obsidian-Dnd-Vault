...
```leaflet  
id: KullCityMapLeaf ### Must be unique with no spaces  
image: [[Kull.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [4359, 3856]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
...
long: 1928 ### To center the map, make this half of the map width.  
