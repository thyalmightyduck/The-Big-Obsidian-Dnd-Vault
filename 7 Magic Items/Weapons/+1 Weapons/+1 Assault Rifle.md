...
_The base item can be found in The Gunslinger Class: Valda’s Spire of Secrets._
...
**Reload:** This weapon can be used to make a number of attacks before it must be reloaded. If you are proficient with the weapon, reloading it takes an [[Action]] or a [[Bonus Action]]; otherwise, reloading it takes an [[Action]].
