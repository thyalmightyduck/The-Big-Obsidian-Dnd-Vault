...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30 [[Hit Point]]s per 10-foot section, and it has [[Immunity]] to Cold, Poison, and Psychic damage and [[Vulnerability]] to Fire damage. Reducing a 10-foot section of wall to 0 [[Hit Point]]s destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
...
**Classes:** [[Wizard]]
**Subclasses:** [[Arcana Domain Cleric]], [[Evoker Wizard]], [[Frost Sorcery Sorcerer]], [[Occultist Guild Monster Hunter]], [[Sanguine Thief Rogue]], [[Spellslinger Gunslinger]], [[Way of the Arcane Hand Monk]]