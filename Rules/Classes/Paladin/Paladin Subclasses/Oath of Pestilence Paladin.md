...
When you are reduced to 0 [[Hit Point]]s and not killed outright, you can spend any number of [[Hit Dice]], roll them, and reduce the damage taken by the total rolled on those dice.
...
**One with Plague:** You have [[Immunity]] to Poison damage and the [[Poisoned]] condition, and you have [[Resistance]] to Necrotic damage.
