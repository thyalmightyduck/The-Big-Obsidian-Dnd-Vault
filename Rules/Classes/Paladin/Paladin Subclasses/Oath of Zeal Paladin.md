...
For 1 minute, your weapon attacks and [[Unarmed Strike]]s against the chosen creature can score a [[Critical Hit]] on a roll of 19 or 20 on the d20. In addition, whenever the target starts its turn, you can take a [[Reaction]] to make a melee attack against that creature if it's within reach.
...
| ------------- | ------------------------------------------ |
| 3             | [[Detect Evil and Good]], [[Hunters Mark]] |
