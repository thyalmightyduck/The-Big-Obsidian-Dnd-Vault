...
### Level 17: K.O
Once per turn when you hit a creature with an [[Unarmed Strike]], you can attempt to knock the target out. The target takes extra Force damage equal to three rolls of your Martial Arts die. If the target has 100 [[Hit Point]]s or fewer after you deal damage with the [[Unarmed Strike]], it has the [[Unconscious]] condition for 10 minutes.
Once you use this feature, you can't use it again until you finish a [[Short Rest]] or [[Long Rest]]. You can also restore your use of it by expending 5 Focus Points (no action required).
