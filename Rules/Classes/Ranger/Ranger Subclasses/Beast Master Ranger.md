...
**Restoring or Replacing the Beast:** If the beast has died within the last hour, you can take a [[Magic action]] to touch it and expend a spell slot. The beast returns to life after 1 minute with all its [[Hit Point]]s restored.
...
When you take a [[Bonus Action]] to command your Primal Companion beast to take an action, you can also command it to take the [[Dash Action]], [[Disengage Action]], [[Dodge Action]], or [[Help action]] using its [[Bonus Action]].
...
In addition, the first time each turn it hits a creature under the effect of your [[Hunters Mark]] spell, the beast deals extra Force damage equal to the bonus damage of that spell.
