...
**Bolstering Flames:** You or one creature you can see within 30 feet of yourself gains [[Temporary Hit Point]]s equal to 1d4 plus your Charisma modifier.
...
Your Spellfire Burst improves. You add your Sorcerer level to the [[Temporary Hit Point]]s gained from Bolstering Flames, and the damage of Radiant Fire increases to 1d8.
...
**Burning Life Forc:**. Once per turn when you are hit by an attack roll, you can expend a number of [[Hit Point Dice]], up to a maximum equal to your Charisma modifier (minimum of one). Roll the expended dice, and reduce the amount of damage from that attack equal to the total rolled.
