...
When you cast [[Summon Aberration]], you can modify it so that it doesn't require [[Concentration]]. If you do so, the spell's duration becomes 1 minute for that casting, and when summoned, the Aberration has a number of [[Temporary Hit Point]]s equal to your Warlock level plus your Charisma modifier.
