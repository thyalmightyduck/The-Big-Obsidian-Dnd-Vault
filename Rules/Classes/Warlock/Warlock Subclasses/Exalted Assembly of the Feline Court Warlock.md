...
| ----- | ----------------- | --------------------------------------------------------------------------- | ----------- | -------- | --------------- | ----------- | ---------- |
| 1st   | +2                | Eldritch Invocations,<br><br>Pact Magic,<br><br>Eldritch Invocation Options | 1           | 2        | 2               | 1           | 1          |
...
Spell Slots. The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [[Short rest]] or [[Long Rest]].
...
### Agonizing Blast
_Prerequisites: Level 2+ Warlock, a Warlock Cantrip That Deals Damage_
...
### Devouring Blade
_Prerequisites: Level 12+ Warlock, Thirsting Blade_
...
### Eldritch Smite
_Prerequisites: Level 5+ Warlock, Pact of the Blade_
...
_Prerequisites: Level 9+ Warlock, Pact of the Tome_
...
_Prerequisites: Level 5+ Warlock, Pact of the Chain_
...
[[Resistance]]. When the familiar takes damage, you can take a [[Reaction]] to grant it [[Rules/Core Rules/Resistance]] against that damage.
...
### Repelling Blast
_Prerequisites: Level 2+ Warlock, a Warlock Cantrip That Deals Damage via an Attack Roll_
...
“_If man could be crossed with a cat, it would improve man but deteriorate the cat._”
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 3             | [[Animal Friendship]], [[Cats Spring]], [[Feather Fall]], [[Feline Grace]], [[Misty Step]], [[Speak with Animals]]                          |
...
**Game Statistics:** Your game statistics are replaced by the Beast's stat block, but you retain your creature type; [[Hit Point]]s; [[Hit Point Dice]]; Intelligence, Wisdom, and Charisma scores; class features; languages; and feats. You also retain your skill and saving throw proficiencies and use your [[Proficiency Bonus]] for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast's stat block is higher than yours, use the one in the stat block.
...
- **Annoy:** The target has [[Disadvantage]] on [[D20 Test]]s until the end of your next turn.
...
- If you take damage while you have 0 [[Hit Point]]s, you can expend 1 life to not suffer a [[Death Saving Throws]] failure. If the damage is from a [[Critical Hit]], you must expend 2 lives to not suffer [[Death Saving Throws]] failures.
- If you are forced to make a [[Death Saving Throws]], you can expend 1 life to cause yourself to succeed instead.
- If you are forced to make a [[Death Saving Throws]], you can expend 5 lives to turn the roll into a 20.
- If you would die from massive damage, you can expend 1 life to be reduced to 0 [[Hit Point]]s instead of being killed outright.
- When you are reduced to 0 [[Hit Point]]s and not killed outright, you can expend 1 life to drop to 1 [[Hit Point]] instead.
