...
### Level 3: Petit Fours
During a short or long rest, you can create a number of magical treats equal to your Charisma modifier (minimum one). Choose one of the flavors from the list below with which to imbue these treats, which remain magical until you finish a short or long rest.

A creature can use an action or bonus action to eat a treat, gaining a benefit based on the treat's flavor which, unless otherwise stated, lasts until the end of its next turn.
