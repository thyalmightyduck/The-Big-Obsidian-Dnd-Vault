...
Also at 6th level, your words can twist the power of fate to create triumph from the promise of future despair. When you make an attack roll or a [[saving throw]], you can gain a +10 bonus to the roll, but the next attack roll or [[saving throw]] you make takes a −10 penalty. If not used, this penalty disappears when you finish a [[short rest]] or [[long rest]].

You can't use this feature again until you finish a [[short rest]] or [[long rest]], or until you are reduced to 0 hit points.
...
- It has [[advantage]] on attack rolls and [[saving throw]]s.
...
When this effect ends, the creature immediately drops to 0 hit points and is dying. Once you use this feature, you can't use it again until you finish a [long rest](https://5e.tools/quickreference.html#bookref-quick,2,resting,0).
