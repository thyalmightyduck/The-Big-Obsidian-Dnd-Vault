...
| ----- | ----------------- | --------------------------------------------------------------------------------- | --------------- | ------------- | -------------- | --- | --- | --- | --- | --- |
| 1st   | +2                | Optional Rule: Firearm [[Proficiency]],<br><br>Magical Tinkering,<br><br>Spellcasting | —               | —             | 2              | 2   | —   | —   | —   | —   |
| 2nd   | +2                | Infuse Item                                                                       | 4               | 2             | 2              | 2   | —   | —   | —   | —   |
| 3rd   | +2                | Artificer Specialist,<br><br>The Right Tool for the Job                           | 4               | 2             | 2              | 3   | —   | —   | —   | —   |
...
##### Core Traits
**[[Hit Point Dice|Hit Point Die]]:** D8 per Artificer level
...
You gain an Artificer subclass of your choice. The [[Alchemist Artificer]], [[Armorer Artificer]], [[Artillerist Artificer]], and [[Battle Smith Artificer]], and [[Cartographer Artificer]] subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Artificer levels. For the rest of your career, you gain each of your subclass's features that are of your Artificer level or lower.
...
| --------------- | ----------------------------------------- |
| 3               | [[Armor of Agathys]], [[Shield of Faith]] |
| 5               | [[Spiritual Weapon]], [[Warding Bond]]    |
| 9               | [[Beacon of Hope]], [[Remove Curse]]      |
| 13              | [[Death Ward]], [[Fire Shield]]           |
| 17              | [[Banishing Smite]], [[Wall of Force]]    |
 ### Level 3: Battle Ready
Your combat training and your experiments with magic have paid off in two ways:

Arcane Empowerment. When you attack with a magic weapon, you can use your Intelligence modifier, instead of Strength or Dexterity, for the attack and damage rolls.
...
Mighty Blade. A nonmagical weapon becomes a magic weapon. You gain a +1 bonus to attack and damage rolls made with the weapon, unless it already had this bonus or a better one.

Returning Weapon. The weapon has the Thrown property with a normal range of 30 feet and a long range of 120 feet. It returns to your hand immediately after it is used to make a ranged attack roll.
...
Perfect Mighty Blade. You gain a +3 bonus to attack and damage rolls made with the weapon, unless it already had this bonus or a better one. Additionally, the first time you attack with your Ghaal'Shaarat on your turn, you can transfer some or all of the weapon's bonus to your [[Armor Class]]. The bonus remains until the start of your next turn.

Elemental Strike. When you hit a creature with an attack roll using your Ghaal'Shaarat, choose one of the following damage types: Acid, Cold, Fire, Lightning, or Thunder. Your Ghaal'Shaarat deals an extra 1d6 damage of the chosen type; and you can cause the weapon to deal the chosen type of damage or its normal damage type.

Soul Bound. You have [[Resistance]] to Psychic damage, and you have [[Immunity]] to the [[Charmed]] and [[Frightened]] conditions.
...
Constant Aura. Your Aura of War is always active, and you can take a [[Bonus Action]] to change its damage type.

Retributive Aura. Whenever an enemy starts its turn in your Aura of War, that creature takes damage equal to the extra damage provided by the aura.

Empower Aura. As a [[Bonus Action]], you can increase the extra damage provided by your Aura of War to 2d6. This increase lasts for 1 minute. You can use this feature a number of times equal to your Intelligence modifier (minimum of once). You regain all expended uses when you finish a [[Long Rest]].