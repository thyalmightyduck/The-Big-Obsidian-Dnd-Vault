...
Shocking Grasp. The force of your strike is quite shocking. The target can't make [[Opportunity Attack]]s until the end of the current turn. While your [[Rage]] is active, it can't make Opportunity Attacks until the start of your next turn.
...
Magic Missile. As an action, you can make three ranged attacks using [[Dart]]s, [[Dagger]]s, or other weapons with Thrown that use Strength for the attack and damage rolls. Because Magic Missile never misses, you have [[Advantage]] on these attack rolls.
