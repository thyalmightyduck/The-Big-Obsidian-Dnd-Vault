...
When you use your Second Wind to regain [[Hit Point]], you can choose a number of allies within a 30-foot [[Emanation]] originating from yourself, up to a number of allies equal to your Charisma modifier (minimum of one). Each of those allies regains [[Hit Point]] equal to 1d4 plus your Fighter level. Once you use this ability, you can't use it again until you finish a [[Short rest]] or [[Long Rest]].
...
When you use Group Recovery, each chosen ally has [[Advantage]] on [[D20 Test]]s until the start of your next turn.
