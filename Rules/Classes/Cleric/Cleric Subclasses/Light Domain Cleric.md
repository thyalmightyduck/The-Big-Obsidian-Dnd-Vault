...
You regain all expended uses of your Warding Flare when you finish a [[Short Rest]] or [[Long Rest]].

In addition, whenever you use Warding Flare, you can give the target of the triggering attack a number of [[Temporary Hit Point]] equal to 2d6 plus your Wisdom modifier.
...
You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](https://5e.tools/variantrules.html#long%20rest_xphb).
