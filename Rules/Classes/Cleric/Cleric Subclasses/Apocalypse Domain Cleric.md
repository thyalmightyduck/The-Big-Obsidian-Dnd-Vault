...
When you or an ally within 120 feet of you is about to make a [[Death Saving Throws]], you can expend a spell slot (no action required) to heal the target a number of [[Hit Points]] equal to ten times the level of the spell slot expended.
