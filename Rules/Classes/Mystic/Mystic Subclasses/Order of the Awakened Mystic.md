...
| ----- | ----------------- | ------------------------------------------------------------------------------------------------ | ------------- | ----------------- | ---------- | --------- |
| 1st   | +2                | Psionics,<br><br>Psionic Disciplines and Talents,<br><br>Using a Discipline,<br><br>Mystic Order | 1             | 1                 | 4          | 2         |
| 2nd   | +2                | Mystical Recovery,<br><br>Telepathy                                                              | 1             | 1                 | 6          | 2         |
| 3rd   | +2                | Mystic Order feature                                                                             | 2             | 2                 | 14         | 3         |
| 4th   | +2                | Ability Score Improvement,<br><br>Strength of Mind                                               | 2             | 2                 | 17         | 3         |
| 5th   | +3                | —                                                                                                | 2             | 3                 | 27         | 5         |
| 6th   | +3                | Mystic Order feature                                                                             | 2             | 3                 | 32         | 5         |
| 7th   | +3                | —                                                                                                | 2             | 4                 | 38         | 6         |
| 8th   | +3                | Ability Score Improvement,<br><br>Potent Psionics (1d8)                                          | 2             | 4                 | 44         | 6         |
| 9th   | +4                | —                                                                                                | 2             | 5                 | 57         | 7         |
...
| 14th  | +5                | Mystic Order feature,<br><br>Potent Psionics (2d8)                                               | 3             | 6                 | 64         | 7         |
...
##### Core Traits
**Hit Point Die:** D8 per Mystic level
**Hit Points at Level 1:** 8 + Con. modifier
**Hit Points per additional Mystic Level:** D8 + your Con. modifier, or, 5 + your Con. modifier
...
**Discipline save DC** = 8 + Intelligence modifier + Proficiency Bonus

**Discipline attack modifier** = Intelligence modifier + Proficiency Bonus

## Level 1: Psionic Disciplines and Talents
[[Psionic talent]]s and [[Psionic discipline]]s are the heart of a mystic's craft. They are the mental exercises and psionic formulae used to forge will into tangible, magical effects.
...
Concentrating on a discipline follows the same rules as concentrating on a spell. This rule means you can't concentrate on a spell and a discipline at the same time, nor can you concentrate on two disciplines at the same time. "Spellcasting," in the Player's Handbook for how [[concentration]] works.

### Targets and Areas of Effect
Psionic disciplines use the same rules as spells for determining targets and areas of effect,  "Spellcasting," of the Player's Handbook.
...
### Level 3: Psionic Investigation
Starting at 3rd level, you can focus your mind to read the psionic imprint left on an object. If you hold an object and concentrate on it for 10 minutes (as if having [[Concentration]] on a psionic discipline), you learn a few basic facts about it. You gain a mental image from the object's point of view, showing the last creature to hold the object within the past 24 hours.
...
## Level 11: Psionic Mastery (1/Day)
...
## Level 13: Psionic Mastery (2/Day)
