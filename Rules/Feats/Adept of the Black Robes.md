...
**Life Channel.** You can channel your life force into the power of your magic. When a creature you can see within 60 feet of you fails a saving throw against a spell that deals damage that you cast, you can expend a number of [[Hit Point Dice|Hit Dice]] equal to the level of the spell. Roll the expended [[Hit Point Dice|Hit Dice]] and add them together. The damage that the creature takes increases by an amount equal to that total.

![[Mages of High Sorcery BGR PNG.png]]