...
- Spend Hit Point Dice. You can spend one or more of your [[Hit Dice]] to regain [[Hit Point]]. For each [[Hit Dice]] you spend in this way, roll the die and add your Constitution modifier to it. You regain [[Hit Point]] equal to the total (minimum of 1 Hit Point). You can decide to spend an additional [[Hit Dice]] after each roll.
