...
Cantrip. You know one cantrip of your choice from the [wizard spell list](https://5e.tools/spells.html#blankhash,flstclass:wizard=1,flstlevel:0=1). Intelligence is your spellcasting ability for it.

Water Creed Navigation. You have proficiency with [navigator's tools](https://5e.tools/items.html#navigator's%20tools_phb) and in the Survival skill.
