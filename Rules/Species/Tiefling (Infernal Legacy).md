...
**Infernal Legacy:** You know the [[Thaumaturgy]] cantrip. Once you reach 3rd level, you can cast the [[hellish rebuke]] spell as a 2nd-level spell with this trait; you regain the ability to cast it when you finish a [[Rules/Core Rules/Long Rest]]. Once you reach 5th level, you can also cast the [[Darkness (Spell)]] spell once per day with this trait; you regain the ability to cast it when you finish a [[Rules/Core Rules/Long Rest]]. Charisma is your spellcasting ability for these spells.
**Languages:** You can speak, read, and write [[Common]] and [[Infernal (Language)]].
...
[[Tiefling]] names fall into three broad categories. Tieflings born into another culture typically have names reflective of that culture. Some have names derived from the [[Infernal (Language)]] language passed down through generations, and reflect their fiendish heritage. And some younger tieflings striving to find a place in the world, adopt a name that signifies a virtue or other concept and then try to embody that concept. For some, the chosen name is a quest. For others, its a grim destiny.
