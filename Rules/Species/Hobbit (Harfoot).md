...
Pipe-Weed Lore. You have proficiency with [pipes](https://5e.tools/items.html#pipe_tlotrr).

Unobtrusive. You can move through the space of any creature that is of a size larger than yours.

Languages. You speak, read and write [Westron](https://5e.tools/languages.html#westron_tlotrr), preserving the use of a few words and names of your own forgotten tongue.
