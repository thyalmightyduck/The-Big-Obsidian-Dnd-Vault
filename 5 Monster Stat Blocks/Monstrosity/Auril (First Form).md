...
> [!infobox]
> # Auril (First Form)
> ![[Auril First Form BGR PNG.png|cover hsmall]]
> ###### Main Info
...
> | Wisdom | +12 | 
> | Languages | All |
> | Languages | [[Telepathy (Languages)]] | 1,000 Feet |
...
> | [[Stunned]] | Immune |
> ###### Description
> In their first form, Auril appears as a hunched, 7-foot-tall biped with the head of a snowy owl, black talons, cloven hooves, and grayish-white wolf fur covering their body from the neck down
# **<u>Traits</u>**  
...
**Talons.** _Melee Weapon Attack:_ +7 to hit, reach 5 ft., one target. _Hit:_ 7 (1d8 + 3) piercing damage plus 3 (1d6) cold damage.

**Touch of Frost.** _Melee Spell Attack:_ +13 to hit, reach 5 ft., one creature. _Hit:_ 13 (3d8) cold damage, and the target can't take reactions until the start of its next turn.

**Chromatic Orb.** _Ranged Spell Attack:_ +13 to hit, range 90 ft., one creature. _Hit:_ 13 (3d8) cold damage.
...
senses: [[Darkvision]] 120Ft, [[Truesight]] 120 Ft. [[Passive Perception]] 26
languages: All, [[Telepathy (Languages)]] 1,000 Ft.
cr: 9
spells: 
  ...
  - At Will: [[Chromatic Orb]] (Cold Orb Obly; See Actions Below), [[Detect Magic]], [[Misty Step]]
  - 2/Day: [[Control Weather]], [[Detect Thoughts]], [[Ice Storm]]  
traits:
  - name: Divine Being
    desc: Auril can't be [[surprised]] and can't be changed into another form against her will  
  - name: Divine Rejuvenation
    desc: When Auril drops to 0 [[hit points]], her body turns to slush and melts away. Auril instantly reappears in her second form, in an unoccupied space within 60 feet of where her first form disappeared. Her initiative count doesn't change.
...
actions:
  ...
  - name: "Talons"
    desc: "_Melee Weapon Attack:_ +7 to hit, reach 5 ft., one target. _Hit:_ 7 (1d8 + 3) piercing damage plus 3 (1d6) cold damage."
  - name: "Touch of Frost."
  - desc: "_Melee Spell Attack:_ +13 to hit, reach 5 ft., one creature. _Hit:_ 13 (3d8) cold damage, and the target can't take reactions until the start of its next turn." 
  - name: "Chromatic Orb"
  - desc: "_Ranged Spell Attack:_ +13 to hit, range 90 ft., one creature. _Hit:_ 13 (3d8) cold damage."  
legendary_actions: 
  - name: Talons
    desc: Auril attacks once with her talons.
  - name: Teleport
    desc: Auril teleports to an unoccupied space she can see within 30 feet of her.
  - name: Touch of The Frost (Costs 2 Actions)
